...
<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
              ...
              <?php $form = ActiveForm::begin(['id' => 'kt_login_signin_fom', 'class'=>'form fv-plugins-bootstrap fv-plugins-framework',
              ...
              'options' => [
                ...
                <!--begin::Title-->
                  ...
                  <?= $form->field($model, 'username')->textInput(['autofocus' => true, 'class' => 'form-control form-control-solid h-auto py-7 px-6 rounded-lg'])->label(false) ?>
                  ...
                  <?= $form->field($model, 'password')->passwordInput(['class' => 'form-control form-control-solid h-auto py-7 px-6 rounded-lg'])->label(false) ?>
                  ...
                  <?php //echo Html::submitButton('Login', ['class' => 'btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3', 'name' => 'login-button', 'id' => 'kt_login_signin_submit_2']) ?>
                  <?php echo Html::submitButton('Login', ['class' => 'btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3', 'name' => 'login-button', 'id' => 'kt_login_signin_submi']) ?>
